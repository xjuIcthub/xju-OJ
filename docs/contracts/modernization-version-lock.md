...
| PostgreSQL | **18.6 primary**, `17.11` fallback only after a documented PG18 blocker | supported major; no LTS label | release base `postgres:18.6-alpine@sha256:d3e1620b530c944afa6e887d22eb899824da68e19c52024bf98f5220c88a65b2`; `deploy/images/postgres/Dockerfile` replaces `gosu` 1.19 with source commit `6456aaa0f3c854d199d0f037f068eb97515b7513` rebuilt by `golang:1.26.5-bookworm@sha256:53eeac89074db483fdf0ab3be1df32bf6e47562263d2d0d6baa7f26acb4957dd`; release output is pinned by its manifest digest | independent DB release and fresh runtime root |
| Redis | `6.2.23` → `7.4.10` → `8.2.8`; no direct 4→8.2 cutover | GA/Extended as applicable; no OSS LTS label | tested ladder keeps `redis:6.2.23-bookworm@sha256:a873de27e877d8ea401f530a4c7571bae34882a7178a0a0f3df12263bfba14a5` → `redis:7.4.10-bookworm@sha256:e9b2e45ecd47fbb69b877cf8d045d5cccaaaed52524b6e098b4abe8212994f73`; final release uses `redis:8.2.8-alpine@sha256:a7859ed111db3c1f5404a973a4747505d559fb5ca32d37e447afc0ef845a2103` and is pinned again after GHCR publication | independent Redis release/volume |
...
| Judge Node package manager | Node remains `24.19.0`; bundled npm is security-refreshed to `11.19.0` so its bundled `tar` is `7.5.19` |
