...
- Runtime roots are intentionally empty and root-owned. The external production Secret gate is still pending; no secret was generated or requested. Under the Phase model this blocks only Phase 5 production release. Phase 1–4 may use isolated, disposable, Git-ignored test Secret files and continue WSL/huawei1 smoke.
