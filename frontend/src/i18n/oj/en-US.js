export const m = {
  ...
  Remote_Judging: 'Judging on provider',
  Remote_Submitting: 'Connecting to provider',
  Remote_Result_Stale_Hint: 'No recent result has arrived. Sync the result to continue checking, or continue an unsubmitted task to complete login or verification.',
  Remote_Keep_Tab_Hint: 'Keep an OJ tab open to synchronize the remote result automatically.',
  Remote_Sync_Result: 'Sync result',
  Remote_Continue_Submission: 'Continue submission',
  Remote_Update_Helper: 'Update the remote submission helper to version 1.1.0 or later, then refresh the OJ page.',
  Remote_Recovery_Failed: 'Recovery is temporarily unavailable. Please retry.',
  Remote_Bridge_Required_Title: 'Update the remote submission helper',
  // 404.vue
  Go_Home: 'Go Home',
  // Problem.vue
  ...
  Contest_Practice_Notice: 'The contest has ended. Practice submissions do not affect the contest ranking.',
  ...
  // OIDC auth_error notifications (authError.js)
  Auth_Error_Account_Claim_Conflict: 'This Authentik account cannot be linked automatically because it conflicts with an existing link. Please contact an administrator to resolve it.',
  Auth_Error_Account_Claim_Invalid: 'Your Authentik account is missing required account information. Please contact an administrator.',
  Auth_Error_Account_Claim_Mismatch: 'The Authentik account information does not match this OJ account. Please contact an administrator to check the account binding.',
  Auth_Error_Account_Disabled: 'This account has been disabled. Please contact an administrator.',
  Auth_Error_Account_Link_Required: 'This Authentik account is not linked to an OJ account yet. Please contact an administrator to link the accounts, then sign in again.',
  Auth_Error_Account_Missing: 'The OJ account linked to this Authentik account could not be found. Please contact an administrator.',
  Auth_Error_Authorization_Code_Missing: 'The sign-in response was incomplete. Please start the Authentik sign-in again.',
  Auth_Error_Authorization_Denied: 'The Authentik sign-in was cancelled or denied. Please try again and approve the login request.',
  Auth_Error_Discovery_Unavailable: 'The identity service could not be reached. Please try again in a moment.',
  Auth_Error_Email_Invalid: 'The email address on your Authentik account is not valid. Please correct it in Authentik, then sign in again.',
  Auth_Error_Email_Not_Verified: 'Your email address is not verified yet. Please finish email verification in Authentik, or use password recovery if you cannot access it.',
  Auth_Error_Identity_Already_Linked: 'This Authentik account is already linked to another OJ account. Please contact an administrator.',
  Auth_Error_Id_Token_Algorithm: 'Your sign-in could not be verified securely. Please try again, and contact an administrator if it keeps failing.',
  Auth_Error_Id_Token_Invalid: 'Your sign-in response could not be verified. Please start the Authentik sign-in again.',
  Auth_Error_Id_Token_Key: 'The key needed to verify your sign-in is unavailable. Please try again later, or contact an administrator.',
  Auth_Error_Id_Token_Missing: 'The sign-in response was incomplete. Please start the Authentik sign-in again.',
  Auth_Error_Issuer_Mismatch: 'The Authentik sign-in service is not configured correctly. Please contact an administrator.',
  Auth_Error_Jwks_Unavailable: 'Sign-in credentials could not be verified right now. Please try again in a moment.',
  Auth_Error_Link_Login_Required: 'Please sign in to your OJ account with your password before linking an Authentik account.',
  Auth_Error_Link_Session_Changed: 'Your sign-in session changed during account linking. Please sign in again and retry the link.',
  Auth_Error_Oidc_Configuration: 'Authentik sign-in is unavailable because it is not configured correctly. Please contact an administrator.',
  Auth_Error_Oidc_Disabled: 'Authentik sign-in is currently unavailable. Please sign in with your password, or contact an administrator.',
  Auth_Error_Oidc_Protocol_Error: 'The sign-in response was incomplete or invalid. Please start the Authentik sign-in again.',
  Auth_Error_Provisioning_Failed: 'Your OJ account could not be created automatically. Please try again; if the problem continues, contact an administrator.',
  Auth_Error_State_Expired: 'Your sign-in session has expired. Please start the Authentik sign-in again.',
  Auth_Error_State_Invalid: 'Your sign-in session was interrupted. Please start the Authentik sign-in again.',
  Auth_Error_State_Missing: 'Your sign-in session was interrupted. Please start the Authentik sign-in again.',
  Auth_Error_Subject_Mismatch: 'Your identity could not be confirmed consistently. Please start the Authentik sign-in again.',
  Auth_Error_Token_Exchange_Failed: 'Signing in with Authentik failed. Please start the Authentik sign-in again.',
  Auth_Error_Userinfo_Invalid: 'Your Authentik profile could not be read. Please try again.',
  Auth_Error_Userinfo_Unavailable: 'Your Authentik profile is temporarily unavailable. Please try again later.',
  Auth_Error_Generic: 'Sign-in could not be completed. Please try again, or use your password to sign in.',
  // OIRank.vue
