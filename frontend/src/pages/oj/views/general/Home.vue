<template>
  <Row type="flex" justify="space-around">
    ...
    <panel shadow v-if="contests.length" class="contest">
      <template #title><div >
        <LegacyButton type="text"  class="contest-title" @click="goContest">{{contests[index].title}}</LegacyButton>
      </div></template>
        ...
        <CarouselItem v-for="(contest, index) of contests" :key="index">
          <div class="contest-content">
            <div class="contest-content-tags">
              <LegacyButton type="info" shape="circle" size="small" icon="calendar">
                {{ $filters.localtime(contest.start_time, 'YYYY-M-D HH:mm') }}
              </LegacyButton>
              <LegacyButton type="success" shape="circle" size="small" icon="android-time">
                {{getDuration(contest.start_time, contest.end_time)}}
              </LegacyButton>
              <LegacyButton type="warning" shape="circle" size="small" icon="trophy">
                {{contest.rule_type}}
              </LegacyButton>
            </div>
