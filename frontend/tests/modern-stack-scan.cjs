...
assert.ok(home.includes('home-problem-table') && home.includes('problemIdCollator') && home.includes('.slice(0, 2)'), 'home problems must remain a newest-first table with at most two tags')
