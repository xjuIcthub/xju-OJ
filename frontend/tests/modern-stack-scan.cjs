...
assert.ok(profileSetting.includes("$t('m.Profile_Onboarding_Notice')"), 'profile save must advertise optional onboarding fields')
assert.ok(zhCN.includes("Profile_Onboarding_Notice: '个人资料字段均为可选项"), 'localized optional onboarding notice is missing')
